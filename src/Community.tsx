...
function ExpandablePost({
  ...
  return (
    <>
      <button
        className="post-open"
        data-guide-target={`post-open:${doc.id}`}
        onClick={onOpen}
      >
      ...
      <Button
        ...
        data-guide-target={`post-expand:${doc.id}`}
        variant="ghost"
...
export function Community({
  ...
  return (
    <ButtonGuidance
      role={role}
      scope={
        groupDraft || deletingGroup || annotating
          ? "private"
          : post
            ? `post:${post.id}`
            : "board"
              ...
              >
                <header className="group-heading">
                  <div className="group-title-row">
                    ...
                    <button
                      className="group-add"
                      data-guide-target={`group-add:${group.id}`}
                ...
                <div className="group-posts">
                      ...
                      >
                        ...
                        <footer>
                          ...
                          <button
                            ...
                            data-guide-target={`post-comments:${item.id}`}
                  ...
                  <button
                    ...
                    data-guide-target={`group-new:${group.id}`}
                    onClick={() => onCreate(group.id)}
                  >
                    <Plus size={18} />
          ...
          >
            <div className="modal-form">
              ...
              <div className="delete-group-summary">
                <strong>
                  원고{" "}
                  {docs.filter((d) => d.groupId === deletingGroup.id).length}개
                </strong>
                <span>
                  게시한 글{" "}
              ...
              <p>
                작성 중인 글과 게시글, 댓글, 피드백을 함께 휴지통으로 옮겨요.
                30일 안에 복원할 수 있습니다.
              </p>
              <div className="modal-footer">
