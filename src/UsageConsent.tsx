        ...
        <Modal title="이용약관 · 개인정보 안내" onClose={() => setOpen(false)}>
          <div className="usage-terms-content">
            ...
            <section>
              ...
              <p>
                이름 또는 별명과 출석 번호, 작성한 글·댓글·피드백·메시지,
                접속·재입장 정보를 수업 참여, 글 저장, 피드백과 연결 유지에
                사용해요. 실명 대신 선생님이 알아볼 수 있는 별명을 써도 좋아요.
              </p>
            </section>
            <section>
            ...
            <section>
              ...
              <p>
                중앙 서버는 글 본문을 저장하지 않아요. 직접 연결이 실패하면 글과
                피드백을 중앙 서버가 메모리에서 중계해요. 이름·출석 번호·방
                정보·접속 신호는 연결을 위해 임시 처리하고 방 정리 시 삭제해요.
                서비스 접속 시 연결 상태·오류 코드 등의 진단 기록을 남기며,
                이름·글 본문·입장 코드는 이 기록에 넣지 않아요. 진단 기록은
                서버의 용량 한도에 따라 오래된 순서로 교체돼요.
              </p>
            </section>
            <section>
    ...
    <div className="usage-consent-notice">
      ...
      <div>
        ...
        <p className="usage-consent-summary">
          이름·별명·출석 번호와 글은 수업·피드백에 사용하고, 참여 기기에
          보관해요.
        </p>
